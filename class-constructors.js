...
class Car{
    ...
    car = new Car("Nissan","Altima",2012,true);
    console.log(car);
...
const rental = new Rental(car, "Trizah Mokos", "2023-05-01", "2023-05-05");
...
const question = new Question("Where is mount kilimanjaro found?", ["Kenya", "Uganda", "Tanzania", "Rwanda"], "Tanzania");
const userAnswer = "Tanzania";
...
const question1 = new Question("where is lake Naivasha found?", ["Nakuru", "Kisumu", "Mombasa", "Naoribi"], "Nakuru");
const question2 = new Question("Which among the following is county number 016?", ["Nairobi", "Naivasha", "Meru", "Turkana"], "Machakos");
quiz1.addQuestion(question1);
quiz1.addQuestion(question2);
quiz1.submitAnswer("Nakuru");
quiz1.nextQuestion();
quiz1.submitAnswer("Machakos");
